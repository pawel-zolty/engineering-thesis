...
%                on                  niestety polskie literki są zlepkami
...
%\brokenpenalty=10000		% nie dziel wyrazów między stronami (trzeba było zamarkować, bo w lstlistings nie działało dzielenie linii)
...
\setlength{\cftbeforechapterskip}{.5em} % odstępy w spisie treści 
...
%%\usepackage{tcolorbox} % przerzucono za ifpdf, bo był konflikt opcji
%%%\usepackage{array}
\usepackage{colortbl}
%%\tcbuselibrary{skins}
...
%                  Początek dokumentu 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\includeonly{rozdzial01, rozdzial02, rozdzial03, skroty} % jeśli chcemy kompilować tylko fragmenty, to można tu je wpisać
...
%zawrzyj w bibliografii źródła niecytowane w pracy
\nocite{net-conainerized, asp-net-adavanced, sukurak-book, design-pattern}
