...
% TO DO: proszę zadbać, by czcionka na rysunkach nie była większa niż czcionka wiodąca tekstu.
\begin{figure}
	\centering
	\fbox{\includegraphics[width=.6\linewidth]{rys02/mediatR-Command.png}}
...
\begin{figure}[h]
	\centering
	\fbox{\includegraphics[width=.8\linewidth]{rys02/mediatR-Notification.png}}
...
\begin{figure}[h]
	\centering
	\fbox{\includegraphics[width=.9\linewidth]{rys02/cqrs.png}}
