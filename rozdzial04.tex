...
\begin{figure}[t]
	\centering
	\fbox{\includegraphics[width=.5\linewidth]{rys04/struktura-fizyczna-client-1.PNG}}
...
\begin{figure}[t]
	\centering
	\fbox{\includegraphics[width=.7\linewidth]{rys04/api-arch.png}}
